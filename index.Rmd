...
**Help! I'm new to R and RStudio. Nonetheless, I want to do something for my career in HR! Only problem, I'm completely new to coding! What do I do?** 
...
If you're asking yourself this question, then you've come to the right place! No better moment to ride the wave of disruptions taking place in HR.
...
I'll end with a discussion on what it means to "think with data" in Chapter \@ref(thinking-with-data) and present an example case study data analysis of house prices in Seattle.
...
* Please let me know if you find any errors, typos, or areas from improvement on my [GitHub issue page](https://github.com/Hendrik147/HR_Analytics_in_R_book/issues) page.

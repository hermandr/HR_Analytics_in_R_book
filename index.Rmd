...
cover-image: images/logos/hranalytics.png
...
needed_CRAN_pkgs <- c(
  ...
  "httr","ibmsunburst","leaflet","lubridate","magrittr","microbenchmark","pander","pdftools",
  "plotly","poppler-cpp",
  "profvis","pryr","purrr","rappdirs","raster","RColorBrewer","readr","rebus",
  "rmarkdown","rvest","scales","sp","stats","stringr","testthat","tidyr","tidymodels",
...
knitr::write_bib(
  ...
  "httr","ibmsunburst","leaflet","lubridate","magrittr","microbenchmark","pander",
  "profvis","plyr","purrr","rappdirs","raster","RColorBrewer","readr",
  "rmarkdown","scales","sp","stats","stringr","testthat","tidyr","tigris",
  "titanic","viridis"),
  "bib/packages.bib"
)
...
dir.create("docs/rds")
file.copy("rds/null_slope_distn.rds", "docs/rds/null_slope_distn.rds", overwrite = TRUE)

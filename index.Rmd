...
subtitle: "Common HR business tasks done with the power of R"
...
graphics: yes
description: "An open-source and fully-reproducible electronic self-training book to assist you in your journey to HR Analytics."
cover-image: "images/hranalytics.jpg"
url: 'https\://book.hranalytics.live/'
...
**Please note that you are currently looking at the "development version" of "HR Analytics in R", which is a work in progress currently being edited and thus subject to frequent change.**
```
...
* *Are you looking to connect with and contribute to "HR Analytics in R"? Then click [here](#sec:connect-contribute) for information on how.*
...
This is version `r version` of "HR Analytics in R" published on `r date`. While a PDF version of this book can be found [here](hrnalyticsinr.pdf){target="_blank"}, this is very much a work in progress with many things that still need to be fixed. We appreciate your patience. 
...
If you would like to contribute to "HR Analytics.live", there are many ways! Let's all work together to make this book as great as possible for as many students as possible!

* Please let me know if you find any errors, typos, or areas from improvement on my [GitHub issues](https://github.com/Hendrik147/HR_Analytics_in_R_book/issues) page.
* If you are familiar with GitHub and would like to contribute even more, please see Section \@ref(sec:about-book) below.

The author would like to thank [Moderndive](https://github.com/moderndive/moderndive_book) for their inspirational presentation at a recent R user conference and for their generous example on how to set up a bookdown book and for the initial introductory pages on how to start using R.
...
* **Latest published version, still in development** The most up-to-date version, which is still in development is available at [https://hranalyticslive.netlify.com/](https://hranalyticslive.netlify.com/)
    + Source code: Available at Hendrik's [GitHub repository page](https://github.com/Hendrik147/HR_Analytics_in_R_book)
...
* Hendrik Feddersen: Long-standing HR practitioner passionate about HR Analytics, Amsterdam, Netherlands.
...
* "HR Analytics in R" is written using the CC0 1.0 Universal License; more information on this license is available [here](https://creativecommons.org/licenses/by-nc-sa/4.0/).

...
graphics: yes
description: "An open-source and fully-reproducible electronic self-training book to assist you in your journey to HR Analytic."
...
**Please note that you are currently looking at the "development version" of "HR Analytics in R", which is a work in progress currently being edited and thus subject to frequent change. For the latest "released version" of "HR Analytics in R, which changes much less frequently, please visit [book.hranalytics.live](https://book.hranalytics.live/).**
```
...
This is version `r version` of "HR Analytics in R" published on `r date`. For previous versions of ModernDive, see Section \@ref(sec:about-book). While a PDF version of this book can be found [here](hrnalyticsinr.pdf){target="_blank"}, this is very much a work in progress with many things that still need to be fixed. We appreciate your patience. 
...
If you would like to connect with "HR Analytics.live", check out the following links:
...
If you would like to contribute to "HR Analytics.live", there are many ways! Let's all work together to make this book as great as possible for as many students and instructors as possible!
...
* **Latest published version** The most up-to-date release:
    ...
    + Available at [HR Analytics.live](https://book.hranalytics.live/)

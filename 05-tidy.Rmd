...
Let's now switch gears and learn about the concept of "tidy" data format by starting with a motivating example. Let's consider the `` data frame included in the `fivethirtyeight` data. Run the following:
